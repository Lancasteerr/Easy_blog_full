...
import cover1 from "@/assets/ArticleCoverImg/1.png";
import cover2 from "@/assets/ArticleCoverImg/2.jpg";
import cover3 from "@/assets/ArticleCoverImg/3.jpg";
import cover4 from "@/assets/ArticleCoverImg/4.jpg";
...
export default {
  ...
  data(){
    return {
      ...
      zIndex: 1,
      ArticleCoverData:[
        {url: cover1, link:"/articlelist"},
        {url: cover2, link:"/articlelist"},
        {url: cover3, link:"/articlelist"},
        {url: cover4, link:"/articlelist"},
      ]
    }
  },
  methods:{
