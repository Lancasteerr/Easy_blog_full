...
class ArticleChangedListenerTest {
    ...
    void committedTransactionShouldRunDerivedStateSynchronization() {
        ...
        verify(fixture.detailCacheStore).evict(7, fixture.detailLock);
        verify(fixture.listCacheStore).evict(7, fixture.listLock);
        verify(fixture.latestIndexStore).increaseVersion();
    ...
    void deletionShouldPublishNegativeCacheBeforeRemovingRankMember() {
        ...
        verify(fixture.detailCacheStore).publishMissing(7, fixture.detailLock);
        verify(fixture.listCacheStore).publishMissing(7, fixture.listLock);
    ...
    void rolledBackTransactionShouldNotRunCacheOrPhysicalFileActions() {
        ...
        verify(fixture.latestIndexStore, org.mockito.Mockito.never()).increaseVersion();
    }
    ...
    void failedCacheActionShouldNotSkipRemainingCompensationActions() {
        ...
        doThrow(new IllegalStateException("redis unavailable"))
                .when(fixture.detailCacheStore)
                .evict(7, fixture.detailLock);
    ...
    private static final class ListenerFixture {
        ...
        private ListenerFixture() {
            when(detailCacheStore.lockKey(7)).thenReturn("detail-lock");
            when(listCacheStore.lockKey(7)).thenReturn("list-lock");
            ...
            when(detailCacheStore.evict(7, detailLock)).thenReturn(true);
            when(listCacheStore.evict(7, listLock)).thenReturn(true);
            when(detailCacheStore.publishMissing(7, detailLock)).thenReturn(true);
            when(listCacheStore.publishMissing(7, listLock)).thenReturn(true);
        }
